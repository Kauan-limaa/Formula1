...
namespace Formula1.Controllers
{
    ...
    public class Equipes : Controller
    {
        ...
        public Equipes(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome_equipe")] Equipe equipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome_equipe")] Equipe equipe)
        {
            if (id != equipe.Id)
            {
                return NotFound();
